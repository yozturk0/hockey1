...
const STR = {
  tr: {
    ...
    'net.waking':       'Sunucu uyanıyor… ilk bağlantı yarım dakika sürebilir.',
    'net.meanwhile':    'Bu arada bilgisayara karşı oyna',
    'net.queued':       'Bağlanır bağlanmaz devam edilecek…',
  ...
  en: {
    ...
    'net.waking':       'Waking the server up — the first connection can take half a minute.',
    'net.meanwhile':    'Play the computer while you wait',
    'net.queued':       'We will carry on the moment it connects…',
